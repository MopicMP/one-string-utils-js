...
> One string truncate, capitalize, slugify for js

[![npm version](https://badge.fury.io/js/one-string-utils-js.svg)](https://www.npmjs.com/package/one-string-utils-js)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install one-string-utils-js
```

## Quick Start

```javascript
const { js } = require('one-string-utils-js');
...
```javascript
const { js, batch } = require('one-string-utils-js');
